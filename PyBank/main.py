...
csv_input_path = os.path.join('c:/Users/Archie Listenbee II/python_challenge/python-challenge/PyBank/raw_data', 'budget_data.csv')
txt_output_path = os.path.join('c:/Users/Archie Listenbee II/python_challenge/python-challenge/PyBank/raw_data', 'budget_data_summary.txt')
