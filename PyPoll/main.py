...
csv_input_path = os.path.join('c:/Users/Archie Listenbee II/python_challenge/python-challenge/PyPoll/raw_data', 'election_data_1.csv')
txt_output_path = os.path.join('c:/Users/Archie Listenbee II/python_challenge/python-challenge/PyPoll/raw_data', "election_analysis.txt")

# list variables tracked
